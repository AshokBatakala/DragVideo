...
def project(
    ...
    print(target.shape,G.img_channels, G.img_resolution, G.img_resolution) #debug --------
    ...
    # these are causing errors image resolution mismatch
    # del G
    # return w_opt.repeat([1, 18, 1])

    G_map_num_ws = G.mapping.num_ws
    del G
