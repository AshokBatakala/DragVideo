...
#NOTE:
#----------------------------------------------------------------------------
# main function is "_render_drag_impl"
#----------------------------------------------------------------------------
print('renderer.py')
...
class Renderer:
    ...
    def _render_drag_impl(self, res,
        ...
        **kwargs
        ...
        if False:
            print('debug')
            # print all arguments to args.txt 
        ...
        if is_drag: 
            ...
            if self.feat_refs is None:
                ...
                for point in points:
                    ...
                    # error: may be because of landmark point outside the resolution
        ...
        img, feat = G(self.w,
                       label, truncation_psi=trunc_psi, noise_mode=noise_mode, input_is_w=True, return_feature=True)
        return feat[feature_idx].detach().cpu().numpy()
