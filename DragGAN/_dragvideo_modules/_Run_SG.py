...
def run_SG(
        ...
        **kwargs
        ...
        img, feat = G(ws, label,
                      ...
                      input_is_w= kwargs.get('input_is_w',True),
                      return_feature=True,
                      set_feature= kwargs.get('set_feature',None),
                    #   **kwargs
                        )
        ...
        return img.detach().cpu().numpy(),feat
...
def lazy_Run(sg_pkl,ws_path,_device="cuda",want_plot=False,**kwargs):
